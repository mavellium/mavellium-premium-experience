        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <nav className="hidden md:flex items-center gap-6">
              <a
                href="https://api.whatsapp.com/send?phone=5514991779502&text=Ol%C3%A1%21%20Vi%20que%20o%20site%20est%C3%A1%20em%20manuten%C3%A7%C3%A3o%20e%20gostaria%20de%20conversar%20sobre%20solu%C3%A7%C3%B5es%20para%20meu%20projeto.%20Podemos%20falar%3F"
                target="_blank"
